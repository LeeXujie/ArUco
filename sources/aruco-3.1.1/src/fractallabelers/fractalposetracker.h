...
namespace aruco {
    ...
    public:
         ...
         */
        cv::Mat fractal_solve_ransac(int ninners, std::vector<std::pair<uint, std::vector<uint>>> inner_kpnt, std::vector<cv::KeyPoint> kpnts, u_int32_t maxIter=500, float _minInliers=0.35f, float _thresInliers=0.7f);
