...
public:
    ...
    //saves the map to a pcd file for visualization with the pcl library. You can use the program pcl_viewer for visualization
...
private:
   ...
   // float markerSize()const{return 1;}
    ...
    vector<uint32_t> relocalizationCandidates(Frame &frame);
