...
void Linear::build ( Matrix features,   const ParamSet &params)throw(std::exception){
...
void Linear::search(Matrix queries, int nn, Matrix indices, Matrix distances, const ParamSet &sparams, std::shared_ptr<cpu_x86> Tcpu)throw(std::exception){
...
void Linear::fromStream(std::istream &str)throw(std::exception){
    assert("Not yet");
