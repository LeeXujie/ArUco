/* cpu_x86.h  : Author           : Alexander J. Yee */
#ifndef _cpu_x86_H
#define _cpu_x86_H
#include <cstdint>
#include <cstring>
...
public:
    inline cpu_x86(){  memset(this, 0, sizeof(*this)); }
...
bool  cpu_x86::detect_OS_x64(){ return true;}
#   endif
#endif
...
bool cpu_x86::detect_OS_AVX512(){ if (!detect_OS_AVX())   return false; uint64_t xcrFeatureMask = xgetbv(_XCR_XFEATURE_ENABLED_MASK); return (xcrFeatureMask & 0xe6) == 0xe6; }
std::string cpu_x86::get_vendor_string(){ int32_t CPUInfo[4]; char name[13];cpuid(CPUInfo, 0); memcpy(name + 0, &CPUInfo[1], 4);memcpy(name + 4, &CPUInfo[3], 4); memcpy(name + 8, &CPUInfo[2], 4); name[12] = '\0'; return name;}
void cpu_x86::detect_host(){     OS_x64 = detect_OS_x64(); OS_AVX = detect_OS_AVX();    OS_AVX512 = detect_OS_AVX512();
    //  Vendor
