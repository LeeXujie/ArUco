...
NYUReader::NYUReader(string path, string version)
{
    ...
    depth2rgb_transformer=cv::Matx44d(	9.9997798940829263e-01,	5.0518419386157446e-03,	4.3011152014118693e-03,2.5031875059141302e-02,
...
cv::Point3f NYUReader::move_depth_to_color_coords(cv::Point3f input){
    return depth2rgb_transformer(input);
}
